...
# This script fetches metadata and PDFs from PubMed using Entrez and Selenium.
# It handles journal abbreviations and ISSNs, and downloads PDFs to a specified folder.
...
chrome_options.add_experimental_option("prefs", {
    "download.default_directory": "/Users/janimiyashaik/Desktop/downloaded_pdfs",
...
def download_via_sdsu_proxy(doi):
    try:
        ...
        if len(driver.window_handles) == 0:
            print("❌ Chrome window closed unexpectedly.")
            return False
